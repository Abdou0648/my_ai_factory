...
MAILCAPDICT = {
    ...
    'audio/*':
        [{'view': '/usr/local/data/data/com.termux/files/usr/bin/showaudio %t', 'lineno': 7}],
    'video/*':
...
class FindmatchTest(unittest.TestCase):
    ...
    def test_findmatch(self):
        ...
        audio_entry = {"view": "/usr/local/data/data/com.termux/files/usr/bin/showaudio %t", 'lineno': 7}
        ...
        cases = [
            ...
            ([c, "audio/wav"],
             {"filename": fname},
             ("/usr/local/data/data/com.termux/files/usr/bin/showaudio audio/wav", audio_entry)),
