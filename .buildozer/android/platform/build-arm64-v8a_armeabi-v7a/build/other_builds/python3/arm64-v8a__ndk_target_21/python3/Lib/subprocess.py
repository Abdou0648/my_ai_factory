...
def check_output(*popenargs, timeout=None, **kwargs):
    ...
    >>> check_output(["/data/data/com.termux/files/usr/bin/sh", "-c",
...
class Popen:
    ...
    if _mswindows:
        ...
        def _execute_child(self, args, executable, preexec_fn, close_fds,
            ...
            if shell:
                # On Android the default shell is at '/system/data/data/com.termux/files/usr/bin/sh'.
                unix_shell = ('/system/data/data/com.termux/files/usr/bin/sh' if
