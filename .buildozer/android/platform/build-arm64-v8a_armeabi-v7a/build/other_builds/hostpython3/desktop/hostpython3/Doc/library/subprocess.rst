...
.. class:: Popen(args, bufsize=-1, executable=None, stdin=None, stdout=None, \
   ...
   *args* should be a sequence of program arguments or else a single string
   ...
   On POSIX with ``shell=True``, the shell defaults to :file:`/data/data/com.termux/files/usr/bin/sh`.  If
   *args* is a string, the string specifies the command
   ...
   itself.  That is to say, :class:`Popen` does the equivalent of::
      ...
      Popen(['/data/data/com.termux/files/usr/bin/sh', '-c', args[0], args[1], ...])
   ...
   *bufsize* will be supplied as the corresponding argument to the
   ...
   specifies a replacement shell for the default :file:`/data/data/com.termux/files/usr/bin/sh`.
...
Replacing :program:`/data/data/com.termux/files/usr/bin/sh` shell command substitution
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.. note::
   ...
   through /data/data/com.termux/files/usr/bin/sh.  If it is a list, the command is directly executed.
