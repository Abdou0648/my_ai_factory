    ...
    if test "X$ECHO" = Xecho; then
      ...
      if test "X`{ print -r '\t'; } 2>/dev/null`" = 'X\t' &&
	   ...
	   test "X$CONFIG_SHELL" != X/bin/ksh; then
        ...
        ORIGINAL_CONFIG_SHELL=${CONFIG_SHELL-/data/data/com.termux/files/usr/bin/sh}
	  ...
	  if test "$prev" != 'sed 50q "[$]0"'; then
	    ...
	    exec ${ORIGINAL_CONFIG_SHELL-${CONFIG_SHELL-/data/data/com.termux/files/usr/bin/sh}} "[$]0" ${1+"[$]@"}
	  else
